...
const palette = {
    light: {
        ...
        background: { paper: '#fff', default: '#fff', neutral: GREY[50] },
    ...
    dark: {
        ...
        background: { paper: GREY[900], default: GREY[850], neutral: GREY[850] },
