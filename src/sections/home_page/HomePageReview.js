import { ChevronRightOutlined, FormatQuote, KeyboardArrowLeft, KeyboardArrowRight } from '@mui/icons-material';
...
export default function HomePageReview() {
    const { loading, reviewList } = useContext(HomePageContext);
            ...
            >
                <Box display={'flex'} flexDirection="column" gap={2}>
                    <Box display={'flex'} alignItems='center' justifyContent={'space-between'}>
                        ...
                        <Button component={Link} href={'/review'} variant='contained' color='secondary' endIcon={<ChevronRightOutlined />}>{t('view_all')}</Button>
                    </Box>
