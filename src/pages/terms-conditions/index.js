...
TermsCondition.getLayout = (page) => <CustomLayoutWithoutSlug>{page}</CustomLayoutWithoutSlug>;

export default function TermsCondition({ slugData, referenceData = '',currentCity }) {
    const data = referenceData?.basicInfo?.find((basic) => basic.setting_type == 'T_C').description || ''
