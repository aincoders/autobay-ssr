...
const EXTERNAL_DATA_URL = 'https://api.okmechanic.store/customer/sitemap/category_with_city';
...
export default async (req, res) => {
    try {
        ...
        const headers = { 'applicationId': '1', 'companyId': '2', 'city': city,'category':category }
